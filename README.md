...
> Built QueueT, a multi‑board real‑time collaborative task manager (React, React Router, Supabase/Postgres) with drag‑and‑drop task management, live presence, and WebSocket‑based multi‑user sync.
